...
This is a third-person shooter game developed in Unreal Engine 5 using C++.

The player must eliminate 5 AI enemies to win while managing health and avoiding enemy fire. 
...
- ✅ **Win Condition:** Kill all 5 enemies
...
| ⬅️ A | Strafe Left |
| ➡️ D | Strafe Right |
| 🖱️ Mouse Movement | Look Around |
| 🖱️ Left Mouse Button | Fire Weapon |
| ⬆️ Spacebar | Jump |
| ⏸️ ESC | Pause/Menu |
...
- ✅ Use of the `UProjectileComponent` to launch projectile actors
...
4. ▶️ **Play** from the editor or package for standalone

### 🎯 First-Time Setup

1. ⚙️ Ensure **Default GameMode** is set to `BP_ThirdPersonShooterGameMode`:
   - Edit → Project Settings → Maps & Modes
2. ✅ Verify **PlayerController** is set to `BP_MainPlayerController` in GameMode
3. 🎨 Check that HUD Widget Class is assigned in PlayerController Blueprint
4. 🤖 Place enemies in the `ThirdPerson` level (at least 5)
